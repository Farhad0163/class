...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2023 at 07:24 PM
...
(1, 'siteName', 'FriensOn'),
(2, 'siteTitle', 'FriensOn'),
(3, 'siteKeywords', 'social, FriensOn, social site'),
(4, 'siteDesc', 'FriensOn v3.0.2 is a Social Networking Platform. With our new feature, user can wonder posts, photos,'),
...
(422, 'welcome_find_more_text', '', 'Find more of what you&#039;re looking for with FriensOn Search.', 'أبحث عن ما تريد مع  نظام بحث واواندر', 'Vind meer van wat je zoekt met FriensOn Search.', 'Trouver plus de ce que vous n &#39;êtes à la recherche d&#39;avec FriensOn Recherche.', 'Finde viel mehr, was Du mit wen-kennt-wer-Suche suchst.', 'Trova più di quello che stai cercando con FriensOn Ricerca.', 'Veja mais do que voc&amp;ecirc; esta procurando com o FriensOn Search.', 'Узнайте больше о том, что вы ищете с помощью функции поиска Pintter.', 'Encuentras más de lo que estás buscando con el nuevo Pintter Buscador.', 'Eğer FriensOn Arama ile aradığınızı daha bulun.'),
...
(445, 'site_keywords_help', '', 'Example: social, FriensOn, social site', 'Example: social, FriensOn, social site', 'Example: social, FriensOn, social site', 'Example: social, FriensOn, social site', 'Beispiel: soziale, wen-kennt-wer, soziale Website', 'Esempio: sociale, FriensOn, sito di social', 'Exemplo: social, FriensOn, site social', 'Пример: социальная сеть, pintter, социальный сайт', 'Ejemplo:, FriensOn, sitio social sociales', 'Örnek: Sosyal, FriensOn, sosyal sitesi'),
...
(666, 'discover_pro_types', '', 'Discover more features with {sitename} PRO packages !', 'اكتشاف المزيد للمحترفين من الميزات مع حزم {sitename}', 'Ontdek meer opties met {sitename} PRO!', 'Découvrez plus de fonctionnalités avec {sitename} PRO !', 'Entdecke mehr Funktionen mit dem {sitename} Pro-Paket !', 'Scopri di più caratteristiche con FriensOn pacchetti PRO !', 'Descubra mais recursos com FriensOn PRO packages !', 'Откройте для себя больше возможностей с FriensOn пакетами PRO !', 'Descubre mas {sitename} funciones con los nuevos paquetes!', '{sitename} PRO paketleri ile daha fazla özellik keşfedin !'),
